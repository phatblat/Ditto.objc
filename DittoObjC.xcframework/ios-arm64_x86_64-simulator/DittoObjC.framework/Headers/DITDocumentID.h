...
/**
 ...
 @return An `NSObject` representation of the document identifier.
 */
- (id)toNative __deprecated_msg("use the `value` property instead.");
...
/**
 ...
 @return A `DITDocumentIDPath` object with the provided index incorporated into the document ID path.
 */
