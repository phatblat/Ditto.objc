...
- (NSDictionary<DITDocumentID *, NSArray<DITUpdateResult *> *> *)updateWithBlock:
    (void (^)(NSArray<DITMutableDocument *> *))block NS_SWIFT_UNAVAILABLE("Use version that accepts an error out param instead");
 ...
 */
- (DITSubscription *)subscribe NS_SWIFT_UNAVAILABLE("Use subscribeWithErr instead");
