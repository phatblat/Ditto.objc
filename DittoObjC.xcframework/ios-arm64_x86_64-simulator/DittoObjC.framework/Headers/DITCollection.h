...
/**
 The name of the history collection. History Tracking is **experimental** and
...
- (nullable DITDocumentID *)insert:(NSDictionary<NSString *, id> *)content
                            withID:(nullable DITDocumentID *)id
                             error:(NSError *_Nullable *)error NS_SWIFT_NAME(insert(_:withID:));
...
- (nullable DITDocumentID *)insert:(NSDictionary<NSString *, id> *)content
                     writeStrategy:(DITWriteStrategy)writeStrategy
                             error:(NSError *_Nullable *)error NS_SWIFT_NAME(insert(_:writeStrategy:));
...
- (nullable DITDocumentID *)insert:(NSDictionary<NSString *, id> *)content
                            withID:(nullable DITDocumentID *)id
                     writeStrategy:(DITWriteStrategy)writeStrategy
                             error:(NSError *_Nullable *)error NS_SWIFT_NAME(insert(_:withID:writeStrategy:));
...
- (nullable DITDocumentID *)insert:(NSDictionary<NSString *, id> *)content
                         isDefault:(BOOL)isDefault
                             error:(NSError *_Nullable *)error __deprecated_msg("use `insert(:writeStrategy:error:)` with an equivalent `DITWriteStrategy` instead.");
...
- (nullable DITDocumentID *)insert:(NSDictionary<NSString *, id> *)content
                            withID:(nullable DITDocumentID *)id
                         isDefault:(BOOL)isDefault
                             error:(NSError *_Nullable *)error NS_SWIFT_NAME(insert(_:withID:isDefault:)) __deprecated_msg("use `insert(:withID:writeStrategy:error:)` with an equivalent `DITWriteStrategy` instead.");
...
/**
 ...
 query-related function calls.
 */
- (DITPendingCursorOperation *)find:(NSString *)query withArgs:(NSDictionary<NSString *, id> *)queryArgs;
