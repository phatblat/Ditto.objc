...
@interface DITTransportConfig : NSObject<NSCopying, NSMutableCopying> {
    @protected DITPeerToPeer *_peerToPeer;
    @protected DITConnect *_connect;
    @protected DITListen *_listen;
    @protected DITGlobalConfig *_global;
}
...
- (instancetype)initWithPeerToPeer:(DITPeerToPeer *)peerToPeer
                           connect:(DITConnect *)connect
                            ...
                            global:(DITGlobalConfig *)global NS_DESIGNATED_INITIALIZER;
