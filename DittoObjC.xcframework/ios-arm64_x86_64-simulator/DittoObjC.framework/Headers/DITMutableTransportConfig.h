...
@property (nonatomic, readwrite, strong) DITMutablePeerToPeer *peerToPeer;
@property (nonatomic, readwrite, strong) DITMutableConnect *connect;
@property (nonatomic, readwrite, strong) DITMutableListen *listen;
@property (nonatomic, readwrite, strong) DITGlobalConfig *global;
