...
- (nullable DITLiveQuery *)observeWithDeliveryQueue:(dispatch_queue_t)dispatchQueue
...
- (nullable DITLiveQuery *)observeWithNextSignalAndDeliveryQueue:(dispatch_queue_t)dispatchQueue
                                                  error:(NSError *_Nullable __autoreleasing *)error
                       eventHandlerUsingDocumentHandles:(void (^)(BOOL,
                                                     NSArray<_DITDocumentHandleWrapper *> *,
                                                     NSArray<_DITDocumentHandleWrapper *> *,
                                                     ...
                                                     void(^_Nullable)(void)))eventHandler NS_SWIFT_NAME(observeWithNextSignal(deliveryQueue:eventHandlerUsingDocumentHandles:));

- (nullable DITLiveQuery *)observeLocalWithNextSignalAndDeliveryQueue:(dispatch_queue_t)dispatchQueue
                                                       error:(NSError *_Nullable __autoreleasing *)error
                            eventHandlerUsingDocumentHandles:
                   (void (^)(BOOL,
                             NSArray<_DITDocumentHandleWrapper *> *,
                             ...
                             NSArray<NSNumber *> *,
                             NSArray<DITLiveQueryMove *> *,
                             void(^_Nullable)(void)))eventHandler NS_SWIFT_NAME(observeLocalWithNextSignal(deliveryQueue:eventHandlerUsingDocumentHandles:));
...
- (nullable NSArray<_DITDocumentHandleWrapper *> *)execWithErr:(NSError *_Nullable __autoreleasing *)error;
...
- (nullable NSDictionary<DITDocumentID *, NSArray<DITUpdateResult *> *> *)updateWithBlock:(void (^)(NSArray<DITMutableDocument *> *))block
                                                                                    error:(NSError *_Nullable __autoreleasing *)error;
- (nullable DITSubscription *)subscribeWithErr:(NSError *_Nullable __autoreleasing *)error;
