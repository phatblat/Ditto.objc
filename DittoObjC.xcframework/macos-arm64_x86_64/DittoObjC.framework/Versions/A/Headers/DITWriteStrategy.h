...
typedef NS_CLOSED_ENUM(NSUInteger, DITWriteStrategy) {
    ...
    /**
     An existing document will be overwritten. This can be thought of as first removing the
     existing document completely and then inserting the new document in its place, if
     there is a pre-existing document.
     */
    DITWriteStrategyOverwrite = 2,
    ...
    /**
     ...
     no-op.
     */
    DITWriteStrategyInsertIfAbsent = 3,
     ...
     */
    DITWriteStrategyInsertDefaultIfAbsent = 4,
};
