 ...
 */
- (void)ditto:(DITDitto *)ditto transportConditionChanged:(enum DITTransportCondition)condition
                                             forSubsystem:(enum DITConditionSource)source;

- (void)ditto:(DITDitto *)ditto identityProviderAuthenticationRequest:(DITAuthenticationRequest *)request;
