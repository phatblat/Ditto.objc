...
/**
 ...
 the value at the specified key as a specific type. You obtain a `DITDocumentIDPath` by subscripting a
 `DITDocumentID` and you can then further subscript a `DITDocumentIDPath` to further specify the key of
...
/**
 ...
 @return The same `DITDocumentIDPath` object with the provided index incorporated into the document ID
 path.
 */
...
/**
 Returns the value at the previously specified key in the document ID as a `BOOL` if possible,
 otherwise the return value will be `nil`.
 */
